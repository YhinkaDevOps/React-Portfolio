      ...
      <div className='max-w-[1700px] mx-auto px-10 flex flex-col-reverse h-full md:flex-row items-center select-none '>
        <div className='homebio-container xl:mx-auto 2xl:mx-auto md:mt-12 sm:mb-5 lg:mt-12 2xl:ml-12 xl:ml-11 flex flex-col  mx-auto md:w-3/5 md:ml-10 xs:space-y-0 xs:mb-[40px] space-y-1 '>
          ...
          <div className='flex space-x-5'>
            ...
            <a href="http://drive.google.com/file/d/1qeE6m50HzfInFYB_kUGJYWFWqrOOs54H/view?usp=drivesdk" target="_blank" rel="noreferrer"  className='flex md:hidden text-white group px-2 py-2 my-2  items-center hover:border-pink-600 hover:bg-pink-600 rounded-md Home-btn sm:text-sm md:text-sm xs:text-xs lg:text-base xl:text-lg xl:py-3 2xl:py-4 2xl:px-4 2xl:text-2xl'>
              Resume
            </a>
          </div>
        </div>
