                  ...
                  <div 
                    ...
                    <div className='opacity-0 group-hover:opacity-100'>
                      ...
                      <div className='pt-8 text-center'>
                        <a href="https://legendary-paprenjak-55b05a.netlify.app/" target={`_blank`}>
                         ...
                         <a href="https://github.com/YhinkaDevOps/Clock-VanillaJs.git" target={`_blank`}>
                          <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-pink-600 hover:text-white'>
                              Code
                          </button>
                        </a>
                    ...
                    <div className='opacity-0 group-hover:opacity-100'>
                      ...
                      <div className='pt-8 text-center'>
                        <a href="https://exquisite-dragon-9b3423.netlify.app/" target={`_blank`} >
                          <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-pink-600 hover:text-white'>
                            Demo 
                          </button>
                        </a>
                         <a href="https://github.com/YhinkaDevOps/Calculator-VanillaJs.git" target={`_blank`}>
                          <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-pink-600 hover:text-white'>
                              Code
                          </button>
                        </a>
                    ...
                    <div  
                      ...
                      <div className='opacity-0 group-hover:opacity-100'>
                        ...
                        <div className='pt-8 text-center'>
                          ...
                          <a href="https://github.com/YhinkaDevOps/Youtube-API" target="_blank">
                            <button className='text-center rounded-lg px-4 py-3 m-2 bg-white text-gray-700 font-bold text-lg hover:bg-pink-600 hover:text-white'>
                                Code
                            </button>
                          </a>
